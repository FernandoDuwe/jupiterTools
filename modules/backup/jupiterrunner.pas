...
begin
  ...
  try
    ...
    begin
      Self.JupiterApp.Config.AddVariable(Self.FAppName + '.Variables.CurrentPath', TratarCaminho(ExtractFileDir(Application.ExeName) + GetDirectorySeparator + 'modules/runner/'), 'Diretório atual');
      Self.JupiterApp.Config.AddVariable(Self.FAppName + '.Variables.CurrentFile', prParams.Params, 'Arquivo atual');
