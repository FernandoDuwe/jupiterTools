...
begin
  ...
  begin
    Self.Config.AddVariable(Self.FAppName + '.Variables.CurrentPath', TratarCaminho(ExtractFileDir(Application.ExeName) + GetDirectorySeparator + 'modules/generator/'), 'Diretório atual');
    Self.Config.AddVariable(Self.FAppName + '.Variables.CurrentFile', prParams.Params, 'Arquivo atual');
