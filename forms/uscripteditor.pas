...
begin
  ...
  vrJupiterApp.Config.AddVariable(vrJupiterApp.AppName + '.Variables.CurrentPath', TratarCaminho(ExtractFileDir(prFileName)), 'Diretório atual');
  vrJupiterApp.Config.AddVariable(vrJupiterApp.AppName + '.Variables.CurrentFile', prFileName, 'Arquivo atual');
