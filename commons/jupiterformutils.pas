...
begin
  ...
  begin
    ...
    if prComponent.Components[vrVez] is TPageControl then
    begin
      for vrVez2 := 0 to TPageControl(prComponent.Components[vrVez]).PageCount - 1 do
        DrawForm(TPageControl(prComponent.Components[vrVez]).Pages[vrVez2]);
